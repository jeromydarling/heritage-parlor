...
KITS = [
    {
        "id": "rainy-day",
        "prompt": (
            "Hand-painted watercolor and ink illustration in the style of an 1880s book plate. NOT a photograph. "
            "Warm sepia, brown, and ochre tones on aged cream paper with visible brushstrokes and ink linework. "
            ...
            "Ornate hand-drawn decorative border with corner flourishes. No text or letters."
        ),
    },
    {
        "id": "restaurant",
        "prompt": (
            "Hand-painted watercolor and ink illustration in the style of an 1890s magazine plate. NOT a photograph. "
            "Warm sepia, brown, and ochre tones on aged cream paper with visible brushstrokes and ink linework. "
            "A family — father, mother, and a young child — seated at a round table with white tablecloth, candle, and teacups, "
            "playing a word game together while waiting for dinner. Victorian restaurant with tiled floor, arched window, potted palm. "
            "Ornate hand-drawn decorative border with corner flourishes. No text or letters."
        ),
    },
    {
        "id": "road-trip",
        "prompt": (
            "Hand-painted watercolor and ink illustration in the style of an 1870s travel book plate. NOT a photograph. "
            "Warm sepia, brown, and ochre tones on aged cream paper with visible brushstrokes and ink linework. "
            "A family inside an ornate Victorian railway carriage compartment, passing countryside through the window. "
    ...
    },
    {
        "id": "holiday-party",
        "prompt": (
            "Hand-painted watercolor and ink illustration in the style of an 1880s holiday book plate. NOT a photograph. "
            "Warm sepia, brown, and ochre tones on aged cream paper with visible brushstrokes and ink linework. "
            "Grand Victorian parlor with roaring fireplace, evergreen garlands and wreath, candles on mantelpiece. "
    ...
    },
    {
        "id": "brain-teaser",
        "prompt": (
            "Hand-painted watercolor and ink illustration in the style of an 1890s scientific journal frontispiece. NOT a photograph. "
            "Warm sepia, brown, and ochre tones on aged cream paper with visible brushstrokes and ink linework. "
            "A Victorian study desk with geometric puzzles: tangram pieces, a compass and protractor, nested wooden boxes, "
